...
export default function App() {
  ...
  // const fetchLocation = async () => {
  //   try {
  //     const response = await fetch('https://671b8cba2c842d92c3806828.mockapi.io/api/v1/locations');
  //     if (!response.ok) {
  //       throw new Error(`HTTP error! status: ${response.status}`);
  //     }
  //     const data = await response.json(); // Chuyển đổi phản hồi sang JSON
  //     setLocation(data); // Sử dụng dữ liệu đã chuyển đổi
  //   } catch (error) {
  //     console.log(error);
  //   }
  // }
  ...
  // const fetchCategory = async () => {
  //   try {
  //     const response = await fetch('https://671b8cba2c842d92c3806828.mockapi.io/api/v1/categories');
  //     if (!response.ok) {
  //       throw new Error(`HTTP error! status: ${response.status}`);
  //     }
  //     const data = await response.json(); // Chuyển đổi phản hồi sang JSON
  //     setCategory(data); // Sử dụng dữ liệu đã chuyển đổi
  //   } catch (error) {
  //     console.log(error);
  //   }
  // }
