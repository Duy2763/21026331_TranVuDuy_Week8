      ...
      <ScrollView style={{flex: 1, paddingHorizontal: 32, paddingVertical: 16}}>
        <View style={{}}>
          <View style={styles.flatTop}>
              <Text style={styles.flatTopTitle}>Category</Text>
              <Image
                style={{width: 20, height: 20}}
          ...
          <FlatList
            ...
            renderItem={({item}) => (
              <View style={{alignItems: 'center',}}>
                  <Image
                    style={styles.flatImageCategory}
        ...
        <View style={{paddingTop: 16}}>
          <View style={styles.flatTop}>
              <Text style={styles.flatTopTitle}>Popular Destination</Text>
              <Image
                style={{width: 20, height: 20}}
                source={require('./assets/images/3gach.png')}
              />
        ...
        <View style={{paddingTop: 16}}>
          <View style={styles.flatTop}>
              <Text style={styles.flatTopTitle}>Recommended</Text>
          </View>
          <FlatList
            ...
            renderItem={({item}) => (
              <View style={{alignItems: 'center',}}>
                  <Image
                    style={styles.flatImageRecommend}
                    source={{uri: item.image}}
                    // source={item.image}
                  />
                  <Text>
